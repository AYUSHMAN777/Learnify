...
const CourseCardSkeleton = () => {
    return (
        <div className="flex flex-col md:flex-row gap-6 border-b dark:border-gray-700 pb-6 mb-6">
...
const CourseNotFound = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[40vh] text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-inner">
            <AlertCircle className="text-red-500 h-16 w-16 mb-4" />
            <h1 className="font-bold text-2xl md:text-3xl text-gray-800 dark:text-white">Course Not Found</h1>
...
const SearchPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8 mt-15 dark:bg-[#202124]">
            <div className="my-6">
