...
const { createCourse, getAllAdminCourses, editCourse, getCourseById, createLecture, getCourseLecture, getlecturebyId, removelecture, editlecture, togglePublishCourse, getPublishedCourses, searchCourse, removeCourse } = require('../controllers/course.controller');
